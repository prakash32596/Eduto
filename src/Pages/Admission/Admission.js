...
import EntranceExams from '../../Mobile-Screens/EntranceExams-M/EntranceExams';
...
const Admission = () => {
  ...
  const dynamicRender = (e) => {
    switch (component) {
      case 'Overview':
        return <div><Overview /></div>;
      case 'Eligibility And Entrance Exams':
        return <div><EntranceExams/></div>;
      case 'Course And Specialisation':
  ...
  return (
    <div className="About">
      ...
      {/* mobile view start */}
      <section className='p-4 d-display' >
        <Row>
          <Col sm={6} >
            <Form.Select aria-label="Default select example" value={component} onChange={selectComponent} >
              <option >Open this select menu</option>
              <option >Overview</option>
              <option >Eligibility And Entrance Exams</option>
              <option>Course And Specialisation</option>
      ...
      <section className='py-0 d-display'>

        {dynamicRender()}
      </section>
      {/* mobile view end */}
      <section className="py-2 px-1 m-display">
        <Container>
          <Row>
            <Col>
      ...
      <section className="py-2 m-display">
        <Container>
          <Row >
            <Col md={8}>
              <div>
