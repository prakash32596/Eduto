...
function HomePage() {
  return (
    <div className="mainHomepage">
      {/* <Header/> */}
      <section  className="search col-12" style={{  position: "", marginTop: '-77px', }}>
        <Container>
                ...
                <Card className="d-flex justify-contnent-end" style={{ width: '16rem', height: '80px' }}>
                  ...
                  <Card.Body className="p-0">
                    <Row>
                      ...
                      <Col>
                        <Card.Text className="py-3" style={{ marginLeft: '-15px', }}>
          ...
          <div className="col-xs-12" style={{ position: "", marginTop: "-50px", padding: "50px", ZIndex: -11 }}>
            <Row>
             <Col  >

            
            <h1 className="headingSection d-flex justify-content-center p-5" style={{
              fontFamily: 'inter',
              fontWeight: '900',
              fontSize: '52px'
            }}>Find The Right College For <span xs={4} style={{ textAlign:'left', color: '#0278FF' }}> You</span></h1>
            </Col>
            </Row>
            <Row>
            ...
            <div className="searchicon2">
              <Row  >
                ...
                <Col md={{ span: 4, offset: 4 }}>
                  <Card style={{ width: '16rem', height: '80px', marginLeft: '200px' }}>
                    {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
                    <Card.Body className="p-0">
                      <Row>
                        <Col xs={5}>
              ...
              <Row>
                ...
                <Col  >
                  <Card style={{ width: '40rem', borderRadius: '10px' }}>
                    {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
                    <Card.Body>
                      <p className="d-flex justify-content-center" style={{ marginTop: '0', }} >Choose A Category To Start Exploring</p>
                      <Row>
                        <Col md="3">
            ...
            <Row>
              <Col>
                <Card style={{ width: '21rem' }}>
                  ...
                  <Card.Body>
                    <Card.Title className="d-flex justify-content-center">Find Your Best Matches</Card.Title>
                    <Card.Text className="d-flex justify-content-center" >
          ...
          <Row>
            <Col md={{ span: 10, offset: 1 }}>
              <Card className="bg-dark text-white">
                <Card.Img src={require('../assets/images/banner.PNG').default} height="300" alt="Card image" />
                <Card.ImgOverlay  >
                  {/* <Card.Title>Card title</Card.Title> */}
                  <Row>
                    <Col xs={8} >
                      <Card.Text style={{ backGroundColor: '#001632 !important', }}>
                        <br />
                        {/* <h1>Ranked Among The Top 3</h1>
                        <h1>Universities  Globally</h1> */}

                      </Card.Text>
                      {/* <Card.Text>Compare Top Universities From Around The World By Subject, Destination And More.
                      </Card.Text>
      ...
      <section  className="blogSection" style={{ width:'100%'}} >
        <Container>
          <div className="py-4">
            <Row>
              <Col>
                <div style={{ width: '21rem',paddingTop:'60px' }}>
                  {/* <Card.Img variant="top" src={require('../assets/images/harvard-university-cambridge-usa@2x.png').default} /> */}
                  <Card.Body>
          ...
          <div>
            <Row>
              ...
              <Col>
                <Card style={{ width: '21rem',height:'360px',backgroundColor:'#002B64',color:'white' }}>
                  {/* <Card.Img variant="top" src={require('../assets/images/anete-lusina-rFKBUwLg_WQ-unsplash@2x.png').default} /> */}
                  <Card.Body>
                    <Card.Title className="d-flex justify-content-center py-5" >LOREM IPUSM</Card.Title>
                    <Card.Text className="d-flex justify-content-center " >
      ...
      <section  className="querySection" style={{ width:'100%'}}>
          <Container>
           <Row>
               <Col>
               <div style={{marginLeft:'-196px',marginTop:'80px'}}>
              ...
              textAlign:'left'
               ...
               <Card className="d-flex justify-contnent-end" style={{ width: '36rem', height: '190px' }}>
                  {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
                  <Card.Body className="p-0">
                    <Row>
                      <Col xs={4}>
                        <Card.Title className="d-flex justify-content-center px-4 py-4"  ><span style={{ backgroundColor: '#E5FAE9', width: '153px', fontSize: '7px', textAlign: 'center', padding: '23px', color: 'green', borderRadius: '20%' }}>
                          {/* <i class="fa fa-search m-0" style={{ color: '#0278FF',fontSize:'26px' }} aria-hidden="true"></i></span> */}
                ...
                <Card className="d-flex justify-contnent-end" style={{ width: '36rem', height: '190px' }}>
                  ...
                  <Card.Body className="p-0">
                    <Row>
                      <Col xs={4}>
                        <Card.Title className="d-flex justify-content-center px-2 py-4"  ><span style={{ backgroundColor: '#E5FAE9', width: '153px', fontSize: '7px', textAlign: 'center', padding: '23px', color: 'green', borderRadius: '20%' }}>
                          {/* <i class="fa fa-search m-0" style={{ color: '#0278FF',fontSize:'26px' }} aria-hidden="true"></i></span> */}
