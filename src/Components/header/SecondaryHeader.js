          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav className="justify-content-end navBar">
              <Nav.Link as={Link} className="navItem" to="/Products">
                <img  src={require('../../assets/images/noun_Share_896160.svg').default} width="25" height="18" /> <span className="pl-0">Share </span> | </Nav.Link>
              <Nav.Link as={Link} className="navItem" to="/Pricing">
              <img src={require('../../assets/images/noun_Share_896160.svg').default} width="25" height="18" /><span className="pl-0">Brochure </span>| </Nav.Link>
              <Nav.Link as={Link} className="navItem" to="/Pricing">
              <img src={require('../../assets/images/noun_Share_896160.svg').default} width="25" height="18" /><span className="pl-0">Compare </span>| </Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
